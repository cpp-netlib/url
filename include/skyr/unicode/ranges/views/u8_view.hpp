...
#ifndef SKYR_UNICODE_RANGES_VIEWS_U8_VIEW_HPP
#define SKYR_UNICODE_RANGES_VIEWS_U8_VIEW_HPP
...
class u8_range_iterator {
 ...
 public:
  ...
  using value_type = std::expected<traits::iterator_value_t<iterator_type>, unicode_errc>;
  /// A reference type
